...
function shouldRedirect(obj) {
  return (obj["currentPath"] !== "register.html" && obj["currentPath"] !== "login.html" &&
    obj["currentPath"] !== "legal_notice.html" && obj["currentPath"] !== "privacy_policy_en.html");
}
...
function checkIfUserIsLoggedIn() {
  ...
  if (sessionStorage.getItem("AccessToken")) {
    return true;
  } else if (shouldRedirect(LoggedInObject) && !sessionStorage.getItem("AccessToken")) {
    redirectToLogin();
  } else {
    return false;
  }
...
async function postDataToDatabase_X(path, data) {
  try {
